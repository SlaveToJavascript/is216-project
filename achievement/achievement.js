var badges = { 
  "spring": {
      ...
      '20': ['locked',"You reacted with an emoji on slack!"],
      '21': ['locked',"You were not a freeloader!"],
      '22': ['locked',"You borrowed and cited a code from codepen.io!!"],
      '23': ['locked','You drank 5 cups of coffee in a day like the Supreme Leader!😎'],
      '24': ['locked','You just look so shag today! So we are giving you a free achievement badge.'],
      '25': ['locked','Your laptop fan is dying! Looks like construction is happening!'],
      '26': ['locked','Stayed in school for 24 hours..!'],
      '27': ['locked','You have dark circles!'],
      '28': ['locked','You are almost dying!'],
      '29': ['locked','You did not fall asleep in class!']
  },
  "summer": {
      '0': ['unlocked',"You've logged in for 10 consecutive days! ❤️"],
      '1': ['unlocked',"You're now fairer than Kim Supreme because you have been stuck at home coding!"],
...
function get_season(id){
  ...
  for (i=0; i<Object.keys(badges[id]).length; i++){
      console.log(badges[id][i])
  ...
  row = document.getElementById("achievements");
  row.innerHTML = str;
}
